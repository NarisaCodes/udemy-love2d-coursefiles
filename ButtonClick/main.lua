...
function love.draw()
  if gameState == 2 then
    love.graphics.setColor(40, 80, 100)
  ...
  love.graphics.print("Time Left: " ..math.ceil(timer), love.graphics.getWidth() / 2, 0)

  if gameState == 1 then
    love.graphics.printf("Click anywhere to begin!", 0, love.graphics.getHeight() / 2, love.graphics.getWidth(), "center")
    love.graphics.print("High Score: " ..math.ceil(highScore), love.graphics.getWidth() / 2, 400)
  end
end
